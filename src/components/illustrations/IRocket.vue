  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 316 237">
    <g id="rocket" transform="translate(-151.4 -150.7)">
      ...
      <g id="rocket-body">
        ...
        <path
          fill="#214a81"
          d="M336.3 285h-18.5a1.6 1.6 0 0 1-1.5-1.3l-1-4.5a1.6 1.6 0 0 1 1.5-1.9h20.6a1.6 1.6 0 0 1 1.5 2l-1 4.4a1.6 1.6 0 0 1-1.6 1.3z"
        ></path>
        <path
          fill="#c1ddf7"
          d="M300.3 238.8s2.8 26.1 11.6 42.7a40.3 40.3 0 0 1 30.6 0s10-14 12.1-44.8c1.2-17.7-.2-38-6-55.4h-41.1a127.2 127.2 0 0 0-7.2 57.5z"
        ></path>
        <path
          fill="#214a81"
        ...
        <path
          fill="#214a81"
          d="M15.8 0A15.8 15.8 0 1 1 0 15.8 15.8 15.8 0 0 1 15.8 0z"
          transform="translate(312 195.1)"
        ></path>
        <path
          fill="#ffd474"
          d="M11 0A11 11 0 1 1 0 11 11 11 0 0 1 11 0z"
          transform="rotate(-76.8 295.7 -89)"
        ></path>
      </g>
    </g>
  </svg>
